local function hwpe(id, bp)
    if bp.Categories and table.find(bp.Categories, 'ANTITELEPORT') and table.find(bp.Categories, 'COMMAND') and
...
function ModBlueprints(all_bps)
    ...
    for id, bp in all_bps.Unit do
        ...
        if bp.Economy and not bp.Economy.xpBaseValue and bp.Economy.BuildCostMass and bp.Economy.BuildCostEnergy and
            bp.Economy.BuildTime and table.find(bp.Categories, 'COMMAND') then
            bp.Economy.xpBaseValue = ACUbaseValue
        end
        if bp.Economy and not bp.Economy.xpBaseValue and bp.Economy.BuildCostMass and bp.Economy.BuildCostEnergy and
            bp.Economy.BuildTime and table.find(bp.Categories, 'SUBCOMMANDER') then
        ...
        if bp.Economy and not bp.Economy.xpValue and bp.Economy.BuildCostMass and bp.Economy.BuildCostEnergy and
            ...
            (
            not table.find(bp.Categories, 'UNTARGETABLE') or bp.Economy.xpBaseValue or
                table.find(bp.Categories, 'PROJECTILE')) then
        ...
        if table.find(bp.Categories, 'CONSTRUCTION') and table.find(bp.Categories, 'ENGINEER') and
            table.find(bp.Categories, 'REPAIR') and table.find(bp.Categories, 'RECLAIM') and
            table.find(bp.Categories, 'ASSIST') and not table.find(bp.Categories, 'SHOWQUEUE') then
            table.insert(bp.Categories, 'SHOWQUEUE')
        end
        ...
        if bp.Categories and table.find(bp.Categories, 'STRUCTURE') and
            (
            table.find(bp.Categories, 'MASSEXTRACTION') or table.find(bp.Categories, 'MASSFABRICATION') or
                table.find(bp.Categories, 'MASSPRODUCTION')) and not bp.Economy.xpTimeStep and
            not table.find(bp.Categories, 'UNTARGETABLE') then
            bp.Economy.xpTimeStep = math.random(99, 119)
            bp.Economy.xpValue = bp.Economy.xpValue * econScaling
        end
        if bp.Categories and table.find(bp.Categories, 'STRUCTURE') and table.find(bp.Categories, 'ENERGYPRODUCTION') and
            not bp.Economy.xpTimeStep and not table.find(bp.Categories, 'UNTARGETABLE') then
            bp.Economy.xpTimeStep = math.random(98, 118)
            bp.Economy.xpValue = bp.Economy.xpValue * econScaling
        end
        if bp.Categories and
            (
            table.find(bp.Categories, 'STRUCTURE') and table.find(bp.Categories, 'ENERGYSTORAGE') or
                table.find(bp.Categories, 'MASSSTORAGE')) and not bp.Economy.xpTimeStep and
            not table.find(bp.Categories, 'UNTARGETABLE') then
            bp.Economy.xpTimeStep = math.random(94, 114)
            bp.Economy.xpValue = bp.Economy.xpValue * econScaling
        end
        if bp.Categories and table.find(bp.Categories, 'INTELLIGENCE') and
            (table.find(bp.Categories, 'STRUCTURE') or table.find(bp.Categories, 'MOBILESONAR')) and
            not bp.Economy.xpTimeStep and not table.find(bp.Categories, 'UNTARGETABLE') then
            bp.Economy.xpTimeStep = math.random(101, 121)
            bp.Economy.xpValue = bp.Economy.xpValue * econScaling
        end
        if bp.Categories and table.find(bp.Categories, 'STRUCTURE') and table.find(bp.Categories, 'SHIELD') and
            not bp.Economy.xpTimeStep and not table.find(bp.Categories, 'UNTARGETABLE') then
        ...
        if bp.Categories and bp.Economy and
            (
            table.find(bp.Categories, 'CONSTRUCTION') or table.find(bp.Categories, 'ENGINEER') or
                table.find(bp.Categories, 'FACTORY') or table.find(bp.Categories, 'SILO') or bp.General.UpgradesTo) and
            not table.find(bp.Categories, 'UNTARGETABLE') then
